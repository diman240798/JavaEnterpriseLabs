...
public class ComputerJdbcDataProvider implements BaseDataProvider<Computer> {


    private static Logger LOG = LogManager.getLogger(ComputerJdbcDataProvider.class);
    ...
    private final String entity = "computer";
        ...
        try {
            runOn(statemnt -> {
                ...
                while (resultSet.next()) {
                    Computer model = getModel(resultSet);
                    result.add(model);
                }
                return true;
            });
    ...
    public Optional<Computer> getById(long id) {
        try {
            Optional<Computer> runOn = runOn(statemnt -> {
