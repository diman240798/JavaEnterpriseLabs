...
public class SodaCsvDataProviderTest {
    private static final File TEST_FILES_FOLDER = new File("tmpTests");
    private static final File DB_FILE = new File(TEST_FILES_FOLDER, "soda.csv");
    private SodaCsvDataProvider dataProvider;
    ...
    public void beforeEach() throws IOException {
        ...
        dataProvider = new SodaCsvDataProvider(DB_FILE);
