...
public class CategoryXmlDataProviderTest {

    private static final File TEST_FILES_FOLDER = new File("tmpTests");
    private static final File DB_FILE = new File(TEST_FILES_FOLDER, "category.xml");
    private CategoryXmlDataProvider dataProvider;
    ...
    public void beforeEach() throws IOException {
        ...
        dataProvider = new CategoryXmlDataProvider(DB_FILE);
