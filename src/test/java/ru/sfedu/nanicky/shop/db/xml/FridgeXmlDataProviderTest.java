...
import ru.sfedu.nanicky.shop.db.csv.FridgeCsvDataProvider;
...
public class FridgeXmlDataProviderTest {
    private static final File TEST_FILES_FOLDER = new File("tmpTests");
    private static final File DB_FILE = new File(TEST_FILES_FOLDER, "fridge.xml");
    private FridgeXmlDataProvider dataProvider;
    ...
    public void beforeEach() throws IOException {
        ...
        dataProvider = new FridgeXmlDataProvider(DB_FILE);
