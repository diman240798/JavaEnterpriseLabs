...
import ru.sfedu.nanicky.shop.db.csv.BucketCsvDataProvider;
...
public class BucketXmlDataProviderTest {
    private static final File TEST_FILES_FOLDER = new File("tmpTests");
    private static final File DB_FILE = new File(TEST_FILES_FOLDER, "bucket.xml");
    private BucketXmlDataProvider dataProvider;
    ...
    public void beforeEach() throws IOException {
        ...
        dataProvider = new BucketXmlDataProvider(DB_FILE);
    ...
    public void update() {
        ...
        Bucket newMike = new Bucket(0, Constants.CATEGORY_COMPUTER);
    ...
    public void updateBad() {
        ...
        Bucket update = new Bucket(0, Constants.CATEGORY_COMPUTER);
