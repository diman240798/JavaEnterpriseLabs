...
public class ReceiptCsvDataProviderTest {
    private static final File TEST_FILES_FOLDER = new File("tmpTests");
    private static final File DB_FILE = new File(TEST_FILES_FOLDER, "receipt.csv");
    private ReceiptCsvDataProvider dataProvider;
    ...
    public void beforeEach() throws IOException {
        ...
        dataProvider = new ReceiptCsvDataProvider(DB_FILE);
